...
loglike_drm <- function(item_par, f_i, r_i, s_i, theta, mod=c("1PLM", "2PLM", "3PLM"), D=1,
  ...
  if(fix.a & mod == "1PLM") {
    ...
    llike <- llike_drm(a=a.val, b=item_par, g=0,
  ...
  if(mod == "2PLM") {
    ...
    # sum of log-likelihood
    llike <- llike_drm(a=item_par[1], b=item_par[2], g=0,
                       f_i=f_i, r_i=r_i, s_i=s_i, theta=theta, D=D)
  ...
  if(!fix.g & mod == "3PLM") {
    ...
    # sum of log-likelihood
    llike <- llike_drm(a=item_par[1], b=item_par[2], g=item_par[3],
                       f_i=f_i, r_i=r_i, s_i=s_i, theta=theta, D=D)
  ...
  if(fix.g & mod == "3PLM") {
    ...
    # sum of log-likelihood
    llike <- llike_drm(a=item_par[1], b=item_par[2], g=g.val,
                       f_i=f_i, r_i=r_i, s_i=s_i, theta=theta, D=D)
